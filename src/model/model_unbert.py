...
from transformers.models.bert.modeling_bert import BertEmbeddings,BertEncoder,BertPooler,BertConfig
...
class UNBertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        # word_hidden = sequence_output[:, 0, :]
        # sentence_hidden = sentence_output[1][:, 0, :]
